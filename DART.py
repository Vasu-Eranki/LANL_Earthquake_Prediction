...
for fold_n,(train_index,val_index) in enumerate(folded):
    ...
    model =lgbm.train(params=params,train_set=training_data,num_boost_round=1000,valid_sets=[training_data,val_data],early_stopping_rounds=200,verbose_eval=200)
...
submission.to_csv("SubmissionDART.csv",index=None,sep=",")